...
![1595396526609](D:\笔记\pic\1595396526609.png)
...
![1595396173505](D:\笔记\pic\1595396173505.png)
...
- 如果打包成功，则会在target目录下生成一个 jar 包
  ...
  ![1595397063721](D:\笔记\pic\1595397063721.png)
...
- 打成了jar包后，就可以在任何地方运行了！OK
  ...
  ![1595397745294](D:\笔记\pic\1595397745294.png)
...
​		![1595409428560](D:\笔记\pic\1595409428560.png)
...
![1595415587435](D:\笔记\pic\1595415587435.png)

**WebMvcAutoConfiguration**

我们在上面的自动配置类随便找一个打开看看，比如 ：`WebMvcAutoConfiguration`

![1595416894611](D:\笔记\pic\1595416894611.png)
...
4. 在SpringBoot的测试类下注入狗狗输出一下；
   ...
   ![1595466913174](D:\笔记\pic\1595466913174.png)
...
8. IDEA 提示，springboot配置注解处理器没有找到，让我们看文档，我们可以查看文档，找到一个依赖！
   ...
   - 注解@ConfigurationProperties(prefix = "person")![1595464671197](D:\笔记\pic\1595464671197.png)

     点击 open Decumentation进入官网![1595465051557](D:\笔记\pic\1595465051557.png)
...
9. 确认以上配置都OK之后，我们去测试类中测试一下：
   ...
   ![1595467734622](D:\笔记\pic\1595467734622.png)
...
3. 再次输出测试一下：指定配置文件绑定成功！
   ...
   ![1595467980925](D:\笔记\pic\1595467980925.png)
...
![1595468231075](D:\笔记\pic\1595468231075.png)
...
![1595480159290](D:\笔记\pic\1595480159290.png)
...
![1595480813196](D:\笔记\pic\1595480813196.png)
...
![1595484043622](D:\笔记\pic\1595484043622.png)
...
![1595484511936](D:\笔记\pic\1595484511936.png)

springboot 启动会扫描以下位置的application.properties或者application.yml文件作为Spring boot的默认配置文件：

![1595482583892](D:\笔记\pic\1595482583892.png)
...
![1595493746481](D:\笔记\pic\1595493746481.png)
...
![1595493884773](D:\笔记\pic\1595493884773.png)
...
1. 我去新建一个项目测试：springboot-data-jdbc ; 引入相应的模块！基础模块
   ...
   ![1595741635349](D:\笔记\pic\1595741635349.png)
...
![1595506633980](D:\笔记\pic\1595506633980.png)

访问：只要是静态资源，SpringBoot就会去对应的路径寻找资源，我们这里访问：http://localhost:8080/webjars/jquery/3.4.1/jquery.js

![1595506019658](D:\笔记\pic\1595506019658.png)

### 第二种静态资源映射规则

1、那我们项目中要是使用自己的静态资源该怎么导入呢？我们看下一行代码；

![1595516976999](D:\笔记\pic\1595516976999.png)
...
![1595517831392](D:\笔记\pic\1595517831392.png)

6、比如我们访问 http://localhost:8080/1.js , 他就会去这些文件夹中寻找对应的静态资源文件；

![1595517869049](D:\笔记\pic\1595517869049.png)
...
![1595518276475](D:\笔记\pic\1595518276475.png)
...
![1595550098734](D:\笔记\pic\1595550098734.png)
...
- 新建一个 index.html ，在我们上面的3个目录中任意一个；然后访问测试  http://localhost:8080/  看结果！
  ...
  ![1595550394178](D:\笔记\pic\1595550394178.png)
...
![1595555521951](D:\笔记\pic\1595555521951.png)
...
![1595557596160](D:\笔记\pic\1595557596160.png)
...
4. 启动测试！
   ...
   ![1595558424003](D:\笔记\pic\1595558424003.png)
...
![1595560097876](D:\笔记\pic\1595560097876.png)
...
2. 我们给 DispatcherServlet 中的 doDispatch方法 加个断点进行调试一下，因为所有的请求都会走到这个方法中
   ...
   ![1595564720595](D:\笔记\pic\1595564720595.png)

3. 我们启动我们的项目，然后随便访问一个页面，看一下Debug信息；

   找到this(<font color=red>就是DispatcherServlet</font>)

   ![1595564823239](D:\笔记\pic\1595564823239.png)

   找到视图解析器（<font color=red>viewResolvers</font>），我们看到我们自己定义的就在这里了；

   ![1595564942873](D:\笔记\pic\1595564942873.png)
...
- 我们去浏览器访问一下：
  ...
  ![1595584684727](D:\笔记\pic\1595584684727.png)
...
- 不加注解之前，访问首页：
  ...
  ![1595587645715](D:\笔记\pic\1595587645715.png)

- 给配置类加上注解：`@EnableWebMvc`

  我们发现所有的SpringMVC自动配置都失效了！回归到了最初的样子；

  ![1595587533039](D:\笔记\pic\1595587533039.png)
...
![1595594403624](D:\笔记\pic\1595594403624.png)
...
2. 建立一个`login.properties`文件，还有一个`login_zh_CN.properties`；发现IDEA自动识别了我们要做国际化操作；文件夹变了！
   ...
   ![1595604595071](D:\笔记\pic\1595604595071.png)

3. 我们可以在这上面去新建一个文件；

   ![1595604664699](D:\笔记\pic\1595604664699.png)

   弹出如下页面：我们再添加一个英文的；

   ![1595605422294](D:\笔记\pic\1595605422294.png)

   这样就快捷多了！

   ![1595605442883](D:\笔记\pic\1595605442883.png)

4. **接下来，我们就来编写配置，我们可以看到idea下面有另外一个视图；**

   ![1595605469344](D:\笔记\pic\1595605469344.png)

   这个视图我们点击 + 号就可以直接添加属性了；我们新建一个login.tip，可以看到边上有三个文件框可以输入

   ![1595605530046](D:\笔记\pic\1595605530046.png)

   然后依次添加其他页面内容即可！

   ![1595605552329](D:\笔记\pic\1595605552329.png)
...
![1595606566975](D:\笔记\pic\1595606566975.png)

我们可以去启动项目，访问一下，发现已经自动识别为中文的了！

![1595606666498](D:\笔记\pic\1595606666498.png)
...
![1595666066757](D:\笔记\pic\1595666066757.png)
...
# 二十六.SpringBoot + Dubbo + zookeeper
...
- 将css，js，img放入到static目录
  ...
  ![1595732299609](D:\笔记\pic\1595732299609.png)
...
![1595732679388](D:\笔记\pic\1595732679388.png)
...
![1595733308730](D:\笔记\pic\1595733308730.png)
...
![1595733680599](D:\笔记\pic\1595733680599.png)



再次看一下首页页面

![1595733822534](D:\笔记\pic\1595733822534.png)
...
![1595734605852](D:\笔记\pic\1595734605852.png)

登录失败页面

![1595734687171](D:\笔记\pic\1595734687171.png)

3、登录页面不友好（密码泄露）

![1595735421990](D:\笔记\pic\1595735421990.png)
...
- 修改`LoginController`跳转页面代码(redirect跳转)
  ...
  ![1595735326186](D:\笔记\pic\1595735326186.png)
...
![1595736334324](D:\笔记\pic\1595736334324.png)
...
![1595681333478](D:\笔记\pic\1595681333478.png)
...
![1595683472896](D:\笔记\pic\1595683472896.png)
...
![1595685749462](D:\笔记\pic\1595685749462.png)
...
![1595685916526](D:\笔记\pic\1595685916526.png)

添加成功页面

![1595685951486](D:\笔记\pic\1595685951486.png)
...
![1595686182138](D:\笔记\pic\1595686182138.png)
...
![1595730457032](D:\笔记\pic\1595730457032.png)
...
![1595730489246](D:\笔记\pic\1595730489246.png)
...
![1595731466761](D:\笔记\pic\1595731466761.png)

错误运行页面

![1595731494875](D:\笔记\pic\1595731494875.png)
...
![1595731955553](D:\笔记\pic\1595731955553.png)
